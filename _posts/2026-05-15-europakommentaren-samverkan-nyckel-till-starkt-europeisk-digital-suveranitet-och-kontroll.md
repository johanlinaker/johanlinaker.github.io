---
title: Europakommentaren - Samverkan nyckel till stärkt europeisk digital suveränitet och kontroll
...
Utomeuropeiska regleringar som [CLOUD Act](https://techlaw.se/vad-ar-cloud-act/) och [FISA 702](https://techlaw.se/vad-ar-foreign-intelligence-surveillance-act-fisa/) i USA:s fall, men likaså kinesiska cybersäkerhetslagar, [kan inte garantera dataintegritet](https://commission.europa.eu/document/download/09579818-64a6-4dd5-9577-446ab6219113_en) från leverantörer från dessa länder som ligger i linje med europeisk datalagstiftning. Sanktioner och exportförbud med begränsad tillgång eller nedsläckning av digitala tjänster har tidigare [tillämpats av USA mot enskilda länder](https://techcrunch.com/2019/07/29/github-ban-sanctioned-countries/), och mer nyligen [mot enskilda individer](https://www.theguardian.com/law/2026/feb/18/international-criminal-court-icc-judges-trump-sanctions).

#### **Ett nytt europeiskt sätt att samarbeta om digital teknik**

Efter ett långsamt uppvaknande har Europa nu börjat att organisera sig i arbetet med att hantera dessa risker och de digitala beroenden som ligger till grund för dem. En del i detta är den framväxande praxis, kultur och gemenskap för öppen innovation och samverkan som nu tar form. Det tydligaste exemplet är det nyligen etablerade [europeiska digitala infrastrukturkonsortiet för digitala allmänningar](https://digital-commons-edic.eu/) ([DC-EDIC](https://digital-strategy.ec.europa.eu/en/policies/edic)).
...
I Tyskland triggades intresset särskilt 2019 efter en rapport till Bundestag som tydliggjorde de [kostnader och risker](https://www.zdnet.com/article/microsoft-poses-threat-to-germanys-digital-sovereignty-warns-study/) som licensberoendena innebar. Detta ledde, via en tidig prototyp med [Project Pheonix](https://www.bundeswirtschaftsministerium.de/Redaktion/EN/Artikel/Digital-World/GAIA-X-Use-Cases/75-phoenix-the-open-source-workplace-for-the-public-sector/use-case.html) till vad som idag är [openDesk](https://www.opendesk.eu/en), en skrivbordssvit byggd av öppna programvarukomponenter likt legobitar. Målet är att skapa en komplett lösning för den enskilde tjänstemannen.

I Frankrike går motsvarande lösning under namnet [La Suite Numerique](https://lasuite.numerique.gouv.fr/), där många av legobitarna är desamma medan andra är nya. De bägge länderna har arbetat sida vid sida kring utvecklingen av de legobitar som är gemensamma och har också fått sällskap av Nederländerna som skapat sin egen motsvarande lösning under namnet [Mijn Bureau](https://minbzk.github.io/mijn-bureau-infra/). 

Det tyska centret för digital suveränitet [ZenDiS](https://www.zendis.de/), franska interministeriella samverkansmyndigheten [DINUM](https://www.numerique.gouv.fr/numerique-etat/dinum/) och nederländska inrikesministeriet [MinBZK](https://oss.developer.overheid.nl/repositories/6f88cd22-9850-4f70-a983-864ddf3ba6ec) är de som utvecklar respektive projekt och som idag utgör grunden för DC-EDIC. Även Italien och Luxemburg har nu anslutit sig som [medlemmar](https://digital-commons-edic.eu/members/), medan Österrike, Danmark, Finland, Flandern, Ungern, Polen och Slovenien anslutit sig som observatörer.

#### **Sverige vid sidan av – avvaktande eller eftertänksamt?**

Sverige har ännu inte anslut sig trots det tydligt överlappande arbetet som pågår från Försäkringskassans sida med [SAFOS](https://safos.se/) – en lightlösning av till exempel openDesk – med fokus på [kommunikation och samverkansverktyg](https://www.youtube.com/watch?v=5H_oifdVWbw). Denna lösning har vuxit fram parallellt med de övriga europeiska initiativen efter att Skatteverket och Kronofogden [dömde ut Skype och Teams](https://www.svt.se/nyheter/lokalt/vasternorrland/myndigheter-larmar-om-sakerhetsproblem-kansliga-uppgifter-kan-hamna-hos-underrattelsetjanst) avseende datahantering, något som senare togs vidare via det svenska myndighetssamverkansinitiativet [eSam](https://www.esamverka.se/vad-vi-gor/trendanalys-omvarldsbevakning-och-radarbild/digital-samarbetsplattform.html). Vinsterna för Sverige att gå med i DC-EDIC är därav uppenbara, då legobitarna är desamma men möjligheterna desto större. 
...
På den kommunala nivån utgör [Sambruk](https://sambruk.se/) en motsvarande och framväxande funktion, i likhet med till exempel [OS2](https://www.os2.eu/) i Danmark och [ADULLACT](https://adullact.org/) i Frankrike. Ett liknande exempel håller på att växa fram organiskt kring AI-plattformen [Eneo](https://docs.eneo.ai/about) med [Sundsvalls kommun](https://utveckling.sundsvall.se/digital-infrastruktur/ai-plattformen-eneo) i spetsen, där målet är att skapa en hållbar förvaltningsstruktur runt projektet.
...
Även här håller DC-EDIC på att forma en strategisk satsning genom upprättandet av en europeisk investeringsfond för suveränitetskritisk teknologi ([EU Sovereign Tech Fund](https://digital-commons-edic.eu/projects/)). Tanken är att utifrån den tyska nationella motsvarigheten _[Sovereign Tech Agency](https://www.sovereign.tech/)_ skapa en modell för europeiska länder att gemensamt finansiera och bidra till att stärka underhållet av öppna teknologier som Europa är beroende av. 

#### **Ett fönster öppnas – frågan är om Sverige kliver in**

Sammantaget finns tecken på en pågående strategisk förflyttning inom Europa mot ökad digital suveränitet. Denna speglas både i praktiken, genom initiativ som DC‑EDIC, och i politiken, som genom EU:s kommande direktiv [Cloud and AI Development Act](https://www.europarl.europa.eu/legislative-train/theme-a-new-plan-for-europe-s-sustainable-prosperity-and-competitiveness/file-cloud-and-ai-development-act), samt EU:s gränsöverskridande [öppna programvarustrategi](https://digital-strategy.ec.europa.eu/en/news/commission-opens-call-evidence-open-source-digital-ecosystems). Hur och när Sverige väljer att ansluta återstår att se, men ett nationellt uppvaknande är en nödvändig förutsättning. Här kan impulser från Bryssel och våra grannländer bli avgörande.